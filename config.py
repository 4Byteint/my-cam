...
PERSPECTIVE_MATRIX_PATH = "./auto_project/calibration/perspective_matrix_180x220.npy"
...
# 先上下排序 再左右排 =([[左上], [右上], [左下], [右下]])，裡面的座標順序是左上開始順時針
...
# [左上], [右上], [左下], [右下]
CALIB_CIRCLES_PTS = [[47.0, 67.0], [133.0, 73.0], [47.0, 157.0], [137.0, 156.0]]
WORLD_CIRCLES_PTS = [(-4.5, 38.44), (4.5, 38.44), (-4.5, 29.44), (4.5, 29.44)]